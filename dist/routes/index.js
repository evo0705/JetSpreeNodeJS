...
router.get('/', function (req, res) {
	res.render('index', {
        ...
        apis: [{
            name: "GET: Search tweets",
            url: "/twitter/user/nodejs",
            desc: "filtered JSON of tweets from twitter api"
        }, {name: "GET: Countries", url: "/countries", desc: "list of countries"}, {
            name: "GET: Requests",
            url: "/requests.js",
            desc: "get list of request"
        }, {name: "GET: Trips", url: "/trips", desc: "get list of trips"}, {
            name: "GET: Image",
            url: "/image/dukenukem.jpg?width=150&height=150",
            desc: "get image from S3"
        }, {
